...
<li class="nav-item dropdown">
  ...
  <div class="card mt-4 p-4 ">
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-body">
                <form id="updateItem" class="post-form" action="user_upd_sql.php" method="post">
                <div class="mb-3 row">
                ...
                <a href="user_view.php" class="btn btn-scale btn-secondary text-uppercase px-4">Back</a>
