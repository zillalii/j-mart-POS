...
<!--  
          ...
          <!-- <li class="nav-item"><a class="nav-link text-danger" href="#"> <i class="fas fa-power-off me-2"></i> Logout</a></li> -->
        </ul>
      </nav>
      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <div class="d-flex justify-content-between align-items-center py-3 border-bottom">
          ...
          <div class="d-flex align-items-center gap-3">
            ...
            <!-- <div class="dropdown">
            <ul class="dropdown-menu dopdown-menu-end border-0" aria-labelledby="accountDropdown">
            <a><img src="img/J-Mart.png" alt="Avatar" class="rounded-circle" width="45" height="45"/></a>
            <li></li>
            <li></li>
            </ul>
            </div> -->
 ...
 <div class="dropdown">
                <a class="d-flex align-items-center text-decoration-none dropdown-toggle text-dark"
                   href="#" id="accountDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">                                            
                    <img src="img/J-Mart.png" alt="Avatar" class="rounded-circle me-2" width="45" height="45"/>                 
